/**
 * HMAC partilhado backend ↔ ai-service (§9). Duplicado no ai-service
 * (ADR-0002: sem package partilhado). Assina `${timestamp}.${rawBody}`.
 */
...
/** Cabeçalhos assinados para chamadas de saída (backend → ai-service). */
